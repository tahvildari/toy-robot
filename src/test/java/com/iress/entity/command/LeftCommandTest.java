...
public class LeftCommandTest {
    ...
    public void moveNorthSuccessfully() throws ValidationException {
        ...
        Assert.assertEquals(new Position(0, 0, Direction.SOUTH), (new LeftCommand(PositionService.getCurrentPosition())).execute());
    }
    ...
    public void moveEastSuccessfully() throws ValidationException {
        ...
        Assert.assertEquals(new Position(0, 0, Direction.WEST), (new LeftCommand(PositionService.getCurrentPosition())).execute());
    }
    ...
    public void moveWestSuccessfully() throws ValidationException {
        ...
        Assert.assertEquals(new Position(0, 0, Direction.EAST), (new LeftCommand(PositionService.getCurrentPosition())).execute());
    }
    ...
    public void moveSouthSuccessfully() throws ValidationException {
        ...
        Assert.assertEquals(new Position(0, 0, Direction.NORTH), (new LeftCommand(PositionService.getCurrentPosition())).execute());
    }
}
